...
struct RGB {
  ...
  inline RGB& operator= (const RGB& rhs) __attribute__((always_inline))
  {
    r = rhs.r;
    g = rhs.g;
    b = rhs.b;
  ...
  // allow assignment from 32-bit (really 24-bit) 0xRRGGBB color code
  inline void setColorCode (uint32_t colorcode) __attribute__((always_inline))
  {
    r = (colorcode >> 16) & 0xFF;
    g = (colorcode >>  8) & 0xFF;
    b = (colorcode >>  0) & 0xFF;
...
inline __attribute__((always_inline)) bool operator== (const RGB& lhs, const RGB& rhs)
{
